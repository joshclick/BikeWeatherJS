var hourlyWeather = function(tableDiv, zipCode, sleepTime) {
    var sleepTime = sleepTime || [21,6], // hours where i dont ride/dont want time
    ...
    var printHourly = function(hourlyData) {
        ...
        // table header
        tableDiv.append($('<thead><tr><th>Date</th><th>Time</th><th>Temp (feels like)</th></tr></thead>'));
    ...
    $.ajax({
        url: 'http://api.wunderground.com/api/01e312a92fcac494/hourly10day/q/' + zipCode + '.json',
        dataType: 'jsonp',
